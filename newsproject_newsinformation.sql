...
CREATE TABLE `newsinformation` (
  ...
  `CategoryNewsID` int(11) NOT NULL,
  PRIMARY KEY (`NewsID`),
  KEY `fk_NewsInformation_CategoryNews1_idx` (`CategoryNewsID`),
  CONSTRAINT `fk_NewsInformation_CategoryNews1` FOREIGN KEY (`CategoryNewsID`) REFERENCES `categorynews` (`CategoryNewsID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `newsinformation` VALUES (1,'sports','2018-05-03 17:06:12','xxx',1);
...
-- Dump completed on 2018-05-04 23:57:31
